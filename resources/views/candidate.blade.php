  ...
  <div class="main main-raised">
    <div class="profile-content">  
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto mr-auto">
            <div class="profile">
              <div class="avatar">
                <img src="/images/block-candidate.png" alt="Circle Image" class="img-raised rounded-circle img-fluid">
              </div>
              <div class="name">
      ...
      @include('layouts.partials.contactform',[
          ...
          'subtitle' => 'Would you like to ask me a question, or do you need help? Please send me a message.'
        ])
